...
asm("\n\
/* void recRun(register void (*func)(), u32 hw1, u32 hw2) */                  \n\
recRun:                                                                       \n\
    /* prologue code */                                                       \n\
    mflr	0           /* move from LR to r0 */                              \n\
    stmw	14, -72(1)  /* store non-volatiles (-72 == -(32-14)*4) */         \n\
    stw		0, 4(1)     /* store old LR */                                    \n\
...
returnPC:                                                                     \n\
    /* end code */                                                            \n\
    lwz		0, 84(1)    /* re-load LR (84 == (32-14)*4+8+4) */                \n\
    addi	1, 1, 80    /* increment SP (80 == (32-14)*4+8) */                \n\
    mtlr	0           /* set LR */                                          \n\
    lmw		14, -72(1)  /* reload non-volatiles (-72 == -((32-14)*4)) */      \n\
    blr                 /* return */                                          \n\
");
